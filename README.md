...
- add regional holiday detection, so these won't be filled (could consume some external api for that or just GET those from some page, e.g. ferienwiki.de/feiertage/de/bayern )
